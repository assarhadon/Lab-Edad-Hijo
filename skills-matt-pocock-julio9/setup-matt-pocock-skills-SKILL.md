...
(Nota: el skill original hacía referencia a varios archivos complementarios — domain.md, issue-tracker-github.md, issue-tracker-gitlab.md, issue-tracker-local.md, triage-labels.md — no copiados aquí — se te pidió solo SKILL.md.)
